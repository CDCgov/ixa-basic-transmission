...
A stochastic transmission model written in Rust with [ixa](https://github.com/CDCgov/ixa),
...
[Disclaimer](DISCLAIMER.md) and [Code of Conduct](code-of-conduct.md). For more
